        ...
        serialize: function () {
          ...
          var ret = schema.order.map(function (id) {
            ...
            if (production.type === "object" || production.type === "nonObject") {
              ...
              var description = options.descriptions ? "<tr class=\"description\"><th></th><td class=\"text999\" colspan=\"2\">"+"<span class=\""+x.cls+"\">"+aan(production.id)+"</span>"+x.ishas+_htmlSerializer.describeExpr(production.expr, true)+".</td></tr>\n" : "";
              var example = "";
              if (options.examples) {
