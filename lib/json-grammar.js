...
//                known.push(expr.id);
    ...
    htmlSerializer: function (options) {
      ...
      options = extend({wrap: 80, annotations: false}, options);
      return {
          ...
          var ret = schema.order.map(function (id) {
            ...
            if (production.type === "object" || production.type === "nonObject") {
              var x = production.type === "object" ?
                { cls: "obj", punctuation: ":" } :
              { cls: "nob", punctuation: "=" };
              var t = "<tr><th id=\"dfn-" + production.id + "\" class=\""+x.cls+"\">" + production.id + "</th><td>" + x.punctuation + "</td><td>" + _htmlSerializer.serializeExpr(production.expr, true) + " ;</td></tr>\n";
              ...
              return "<tr><th id=\"dfn-" + production.id + "\" class=\""+x.cls+"\">" + production.id + "</th><td>" + x.punctuation + "</td><td>" + _htmlSerializer.serializeExpr(rows[0]) + "</td></tr>\n" +
              ...
              return heading + "<tr><th id=\"dcl-"+production.id+"\"class=\"trm\">" + production.id + "</th><td>=</td><td>" + production.regexp + "</td></tr>\n";
            } else {
