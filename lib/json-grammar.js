    ...
    validator: function () {
      return {
        validateLeafType: function (elt, ft, known, lead) {
          ...
          if (refd === undefined)
            throw Error("no definition for " + ft);
          if (refd.type === "object") {
            ...
            return Object.keys(elt).reduce(function (ret, from) {
              return ret.concat(_validator.validateLeafType(from, refd.from, known, lead+EXP)).
                concat(_validator.validateLeafType(elt[from], refd.to, known, lead+EXP));
            }, []);
          } else {
        ...
        validateType: function (elt, t, known, lead) {
          ...
          if (t === ".") {
            ...
            return [Error("validateType: no matching choice testing " + JSON.stringify(elt) + " against " + t.join("|"))];
        ...
        validateReference: function (elt, nob, known, lead) {
          return prepend(this.validateLeafType(elt, nob.id, known, lead), nob.id);
        },
...
//                known.push(expr.id);
        ...
        validate: function (elt) {
          ...
          return this.validateLeafType(elt, schema.start, [], "");
        }
      };
    },
    htmlSerializer: function (options) {
      ...
      return {
        ...
        serializeReference: function (ref) {
          return this.serializeLeafType(ref.id) + ref.card;
        },
        describeReference: function (ref) {
          return this.describeLeafType(ref.id) + ref.card;
        },
